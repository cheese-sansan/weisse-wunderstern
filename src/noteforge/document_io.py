...
def _error(file_path: str, message: str, warnings: list[str] | None = None) -> dict:
...
def _table_to_markdown(rows: Sequence[Sequence[object | None]]) -> str:
    ...
    try:
        ...
        for i, slide in enumerate(prs.slides, 1):
            ...
            for shape in slide.shapes:
                ...
                if shape_value.has_text_frame:
                    for para in shape_value.text_frame.paragraphs:
                        if para.text.strip():
                            lines.append(para.text.strip())
                if shape_value.has_table:
                    table = shape_value.table
...
def _read_odt(file_path: str) -> str:
    try:
        ...
        def _walk(element: Any):
            if getattr(element, "tagName", "") == "text:p":
                txt = ""
